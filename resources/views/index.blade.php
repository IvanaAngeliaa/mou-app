...
<body>
    <div id="navbar" class="flex flex-row items-center justify-center z-10 bg-amber-50">
        <img src="{{asset('images/Logo Cokelat.png')}}" alt="" class="w-16 mt-10 z-10">
    </div>
    ...
    <div id="hero" class="relative w-full h-auto sm:h-auto md:h-screen lg:h-screen bg-amber-50 flex justify-center items-center overflow-hidden">
        <img src="{{asset('images/hero-ornamen.png')}}" alt="" class="z-0 absolute w-full sm:w-full md:w-full lg:w-2/3 bottom-[-150px] sm:bottom-[-150px] md:bottom-[-20px] lg:bottom-[-400px] opacity-50">
        <img src="{{asset('images/hero-daun.png')}}" alt="" class="z-0 absolute bottom-[10px] sm:bottom-[10px] md:bottom-[-20px] lg:bottom-[-40px] w-6/7 opacity-60">
        <img src="{{asset('images/hero-kue.png')}}" alt="" class="z-5 absolute bottom-[5px] sm:bottom-[5px] md:bottom-[-400px] lg:bottom-[-80px] px-2 sm:px-2 md:px-5 lg:px-10" data-aos="zoom-in-up" data-aos-delay="400">
        ...
        <img src="{{asset('images/lengkungan-cokelat.png')}}" class="absolute bottom-0 w-full" alt="">
    </div>
    ...
    <div id="cerita-kami"
        ...
        <img src="{{asset('images/background-cerita.png')}}" alt="" class="absolute bottom-0 w-2/3 opacity-10">
    ...
    <div id="foto-kulkas" class="h-[10rem] sm:h-[10rem] md:h-[20rem] lg:h-[30rem] overflow-clip">
        <img src="{{asset('images/Kulkas.jpg')}}" alt="" class="w-full h-full object-cover">
    </div>
            ...
            <div class=" cards">
                ...
                <div class="card-wrapper rounded-xl mb-10 z-10 flex justify-center items-center">
                    <div class="card relative ">
                        <img src="{{asset('images/produk/tiramisu.png')}}" alt="" class="h-[13rem] sm:h-[13rem] lg:h-[26rem] rounded-xl">
                ...
                <div class="card-wrapper rounded-xl mb-10 z-10 flex justify-center items-center">
                    <div class="card relative">
                        <img src="{{asset('images/produk/caramou.png')}}" alt="" class="h-[13rem] sm:h-[13rem] lg:h-[26rem] rounded-xl">
                        <div class="produk-info absolute top-6 left-8">
                ...
                <div class="card-wrapper rounded-xl mb-10 z-10 flex justify-center items-center">
                    <div class="card relative">
                        <img src="{{asset('images/produk/moucha.png')}}" alt="" class="h-[13rem] sm:h-[13rem] lg:h-[26rem] rounded-xl">
                        <div class="produk-info absolute top-6 left-8">
                ...
                <div class="card-wrapper rounded-xl mb-10 z-10 flex justify-center items-center">
                    <div class="card relative">
                        <img src="{{asset('images/produk/mouberry.png')}}" alt="" class="h-[13rem] sm:h-[13rem] lg:h-[26rem] rounded-xl">
                        <div class="produk-info absolute top-6 left-8">
                ...
                <div class="card-wrapper rounded-xl mb-10 z-10 flex justify-center items-center">
                    <div class="card relative">
                        <img src="{{asset('images/produk/custom-bento.png')}}" alt="" class="h-[13rem] sm:h-[13rem] lg:h-[26rem] rounded-xl">
                        <div class="produk-info absolute top-6 left-8">
                ...
                <div class="card-wrapper rounded-xl mb-10 z-10 flex justify-center items-center">
                    <div class="card relative">
                        <img src="{{asset('images/produk/cover.png')}}" alt="" class="h-[15rem] sm:h-[15rem] lg:h-[30rem] rounded-xl">

                    </div>
                </div>
            </div>
        </div>
        <img src="{{asset('images/background-menu-atas.png')}}" alt="" class="absolute top-0 w-full z-0 opacity-70">
        <img src="{{asset('images/background-menu.png')}}" alt="" class="absolute bottom-0 w-full  z-0 opacity-70">
    </div>
    ...
    <div id="testimoni" class="bg-amber-100 h-auto pt-12 pb-12 flex flex-col overflow-hidden relative">
        ...
        <img src="{{asset('images/ceritakami-ornament.png')}}" alt="" class="z-0 opacity-5 absolute">
        <div class="testimoni-kartu z-10">
            <div class="mySwiper swiper-container px-20 py-20">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/1.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/2.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/3.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/4.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/5.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/6.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/7.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/8.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="img-container">
                            <img src="{{asset('images/foto-testi/9.svg')}}" style="border-radius: 15px;">
                        </div>
                    </div>
                </div>
            </div>
